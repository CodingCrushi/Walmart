import "./Header.css";
import { BsFillGridFill, BsHeart } from "react-icons/bs";
...
const Header = () => {
  return (
    <div className="container-fluid p-0 bg-primary  header_main">
      <div className="header_items">
        <div className="logo header_item">
        ...
        <div className="department header_item">
          <TfiLayoutGrid2Alt color="#fff" size={16} />
          <div className="header_item_text">department</div>
        </div>
        <div className="service header_item">
          <BsFillGridFill color="#fff" size={16} />
          {/* <BsGridFill /> */}
          service
        </div>
        <div className="search_box header_item">
          <InputGroups />
        </div>
        <div className="my_favarite header_item">
          <BsHeart size={16} />
          <div className=" header_item_text">
            <div className="header_sup">Reorder</div>
            <div className="header_sub">My Items</div>
          </div>
        </div>
        <div className="accout header_item">
          <CiUser size={16} />
          <div className=" header_item_text">
            <div className="header_sup">Sign In</div>
            <div className="header_sub">Account</div>
          </div>
        </div>
        <div className="shop header_item">
